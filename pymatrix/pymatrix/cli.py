...
VERSION = "0.1.0"
CONFIG_DIR = Path.home() / ".config" / "pymatrix"
...
def build_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="pymatrix", 
        description="PyMatrix - Personal Digital Rain Animation"
    )
    ...
    parser.add_argument("-v", "--version", action="version", version="pymatrix " + VERSION)
