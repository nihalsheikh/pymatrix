...
const Usage = () => {
  return (
    <section id="usage" className="mb-32 scroll-mt-48">
      ...
      <CommandBlock command="rmatrix" className="mb-6" />
      <p className="text-xl text-fg/80 mb-10 italic">Alternatively, you can also run the app using the shorter <code className="text-accent font-bold bg-accent-soft px-2 py-1 rounded">rmx</code> command in your terminal.</p>
